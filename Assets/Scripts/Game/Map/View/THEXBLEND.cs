...
public class THEXBLEND : MonoBehaviour
{
	...
	private delegate int _reindex_Blend(ref element e, int ver, int col, int row, Color BlendColor);
    ...
    void GenHexMesh(HEX _hex)
    {
		...
		_reindex_Blend reindex_Blend = (ref element _elm, int _ver, int _col, int _row, Color BlendColor) =>
		{
			...
			for (int y = 0; y < _yTile; y++)
			{
				for (int x = 0; x < _xTile; x++)
				{
					...
					if (IsValid(ww, y))
					{
						...
						if( pass == true && bBld)
						{
							vBld.Add( reindex_Blend(ref e, edx[0][0] - nIndexOffset, x, y, C1000) );
							vBld.Add( reindex_Blend(ref e, edx[0][1] - nIndexOffset, x, y, C1000) );
							vBld.Add( reindex_Blend(ref e, edx[0][2] - nIndexOffset, ww, y, C0100) );
						}
						...
						if( pass == true && bBld){
							vBld.Add( reindex_Blend(ref e, edx[0][3] - nIndexOffset, ww, y, C0100) );
							vBld.Add( reindex_Blend(ref e, edx[0][4] - nIndexOffset, ww, y, C0100) );
							vBld.Add( reindex_Blend(ref e, edx[0][5] - nIndexOffset, x, y, C1000) );
						}
						...
						if ( IsValid(nw, y+1) )
						{
							...
							if ( pass == true && bBld){
								if(y%2!=0){
									vBld.Add( reindex_Blend(ref e, edx[3][0] - nIndexOffset, x, y, C1000) );
									vBld.Add( reindex_Blend(ref e, edx[3][1] - nIndexOffset, ww, y, C0100) );
									vBld.Add( reindex_Blend(ref e, edx[3][2] - nIndexOffset, nw, y+1, C1000) );
								}
								else{
									vBld.Add( reindex_Blend(ref e, edx[3][0] - nIndexOffset, x, y, C1000) );
									vBld.Add( reindex_Blend(ref e, edx[3][1] - nIndexOffset, ww, y, C0100) );
									vBld.Add( reindex_Blend(ref e, edx[3][2] - nIndexOffset, nw, y+1, C0100) );
								}
							}
						}
						...
						if (IsValid(sw, y - 1))
						{
							...
							if ( pass == true && bBld){
								if(!(x==0 && y==0)){
									if(y%2!=0){
										vBld.Add( reindex_Blend(ref e, edx[3][3] - nIndexOffset, x, y, C1000) );
										vBld.Add( reindex_Blend(ref e, edx[3][4] - nIndexOffset, sw, y-1, C1000) );
										vBld.Add( reindex_Blend(ref e, edx[3][5] - nIndexOffset, ww, y, C0100) );
									}
									else{
										vBld.Add( reindex_Blend(ref e, edx[3][3] - nIndexOffset, x, y, C1000) );
										vBld.Add( reindex_Blend(ref e, edx[3][4] - nIndexOffset, sw, y-1, C0100) );
										vBld.Add( reindex_Blend(ref e, edx[3][5] - nIndexOffset, ww, y, C0100) );
									}
								}
								else{
									vBld.Add( reindex_Blend(ref e, edx[3][3] - nIndexOffset, x, y, C1000) );
									vBld.Add( reindex_Blend(ref e, edx[3][4] - nIndexOffset, sw, y-1, C0001) );
									vBld.Add( reindex_Blend(ref e, edx[3][5] - nIndexOffset, ww, y, C0100) );	
								}
					...
					if (IsValid(sw, y - 1))
					{
						...
						if ( pass == true && bBld){
							if(!(x==0 && y==0))
							{
								vBld.Add( reindex_Blend(ref e, edx[1][0] - nIndexOffset, x, y, C1000) );
								vBld.Add( reindex_Blend(ref e, edx[1][1] - nIndexOffset, x, y, C1000) );
								vBld.Add( reindex_Blend(ref e, edx[1][2] - nIndexOffset, sw, y-1, C0100) );
							}
							else
							{
								vBld.Add( reindex_Blend(ref e, edx[1][0] - nIndexOffset, x, y, C1000) );
								vBld.Add( reindex_Blend(ref e, edx[1][1] - nIndexOffset, x, y, C1000) );
								vBld.Add( reindex_Blend(ref e, edx[1][2] - nIndexOffset, sw, y-1, C0001) );
							}
						...
						if ( pass == true && bBld){
							if(!(x==0 && y==0))
							{
								vBld.Add( reindex_Blend(ref e, edx[1][3] - nIndexOffset, sw, y-1, C0100) );
								vBld.Add( reindex_Blend(ref e, edx[1][4] - nIndexOffset, sw, y-1, C0100) );
								vBld.Add( reindex_Blend(ref e, edx[1][5] - nIndexOffset, x, y, C1000) );
							}
							else
							{
								vBld.Add( reindex_Blend(ref e, edx[1][3] - nIndexOffset, sw, y-1, C0001) );
								vBld.Add( reindex_Blend(ref e, edx[1][4] - nIndexOffset, sw, y-1, C0001) );
								vBld.Add( reindex_Blend(ref e, edx[1][5] - nIndexOffset, x, y, C1000) );
							}
						}
					}
					...
					if (IsValid(nw, y + 1))
					{
						...
						if( pass == true && bBld){
							vBld.Add( reindex_Blend(ref e, edx[2][0] - nIndexOffset, x, y, C1000) );
							vBld.Add( reindex_Blend(ref e, edx[2][1] - nIndexOffset, x, y, C1000) );
							vBld.Add( reindex_Blend(ref e, edx[2][2] - nIndexOffset, nw, y+1, C0100) );	
						}
						...
						if( pass == true && bBld){
							vBld.Add( reindex_Blend(ref e, edx[2][3] - nIndexOffset, nw, y+1, C0100) );
							vBld.Add( reindex_Blend(ref e, edx[2][4] - nIndexOffset, nw, y+1, C0100) );
							vBld.Add( reindex_Blend(ref e, edx[2][5] - nIndexOffset, x, y, C1000) );
						}
					}
				}
			}
				...
				for (int x = 0; x < _xTile; x++)
				{
					...
					if (IsValid(ww, y))
					{
						...
						if (IsValid(sw, y - 1) && !(x==0 && y==0))
						{
							...
							if ( pass == true && bBld){
								vBld.Add( reindex_Blend(ref e, edx[3][3] - nIndexOffset, x, y, C1000) );
								vBld.Add( reindex_Blend(ref e, edx[3][4] - nIndexOffset, sw, y-1, C0010) );
								vBld.Add( reindex_Blend(ref e, edx[3][5] - nIndexOffset, ww, y, C1000) );
							}
						}
					}
					...
					if (IsValid(sw, y - 1) && !(x==0 && y==0))
					{
						...
						if ( pass == true && bBld){
							vBld.Add( reindex_Blend(ref e, edx[1][0] - nIndexOffset, x, y, C1000) );
							vBld.Add( reindex_Blend(ref e, edx[1][1] - nIndexOffset, x, y, C1000) );
							vBld.Add( reindex_Blend(ref e, edx[1][2] - nIndexOffset, sw, y-1, C0010) );
						}
						...
						if ( pass == true && bBld){
							vBld.Add( reindex_Blend(ref e, edx[1][3] - nIndexOffset, sw, y-1, C0010) );
							vBld.Add( reindex_Blend(ref e, edx[1][4] - nIndexOffset, sw, y-1, C0010) );
							vBld.Add( reindex_Blend(ref e, edx[1][5] - nIndexOffset, x, y, C1000) );
						}
					}
					...
					if (y == 0)
					{
						...
						if (IsValid(x, y - 1))
						{
							...
							if( pass == true ){
								vBld.Add(reindex_Blend(ref e, edx[2][3] - nIndexOffset, x, y, C1000));
								vBld.Add(reindex_Blend(ref e, edx[2][4] - nIndexOffset, x, y, C1000));
								vBld.Add(reindex_Blend(ref e, edx[2][5] - nIndexOffset, x, y-1, C0010));
							}
							...
							if ( pass == true ){
								vBld.Add(reindex_Blend(ref e, edx[2][0] - nIndexOffset, x, y-1, C0010));
								vBld.Add(reindex_Blend(ref e, edx[2][1] - nIndexOffset, x, y-1, C0010));
								vBld.Add(reindex_Blend(ref e, edx[2][2] - nIndexOffset, x, y, C1000));
							}
							...
							if( IsValid( x-1, y-1 )){
								...
								if ( pass == true ){
									if(!(x==0 && y==0))
									{
										vBld.Add(reindex_Blend(ref e, edx[3][0] - nIndexOffset, x, y-1, C0010));
										vBld.Add(reindex_Blend(ref e, edx[3][1] - nIndexOffset, x-1, y-1, C0010));
										vBld.Add(reindex_Blend(ref e, edx[3][2] - nIndexOffset, x, y, C1000));
									}
									else
									{
										vBld.Add(reindex_Blend(ref e, edx[3][0] - nIndexOffset, x, y-1, C0010));
										vBld.Add(reindex_Blend(ref e, edx[3][1] - nIndexOffset, x-1, y-1, C0001));
										vBld.Add(reindex_Blend(ref e, edx[3][2] - nIndexOffset, x, y, C1000));
									}
