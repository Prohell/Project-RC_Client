...
public class Game
{
    ...
    static public void ConnectToServer(Action<bool, string> callback, int p_port)
    {
        NetManager.GetInstance().ConnectToServer(ServerIp, p_port < 0 ? ServerPort : p_port, callback);
    }
