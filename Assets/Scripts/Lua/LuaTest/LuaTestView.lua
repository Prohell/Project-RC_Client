...
function LuaTestView:UpdateItems()
	...
	for i = 0, table.getn(self.TempDataList) do
		...
		local itemView = LuaHelper.GetLuaComponent(item.gameObject, "LuaTestItemView")
...
function LuaTestView:Init()
	...
	-- Load prefab
	LuaHelper.LoadBundleGB("load_preload$g_luatest$ui.assetbundle", "LuaTestItem", System.Action_UnityEngine_GameObject(self["StoreItemPrefab"], self, true))
end
