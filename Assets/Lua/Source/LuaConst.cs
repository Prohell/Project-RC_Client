...
public static class LuaConst
{
    ...
    public static string toluaDir = Application.dataPath + "/Lua/ToLua/Lua";        //tolua lua文件目录
    ...
    public static string luaResDir = string.Format("{0}/{1}", Application.persistentDataPath, "Lua");      //手机运行时lua文件下载目录    
...
#if UNITY_EDITOR
    public static bool openZbsDebugger = true;         //是否连接ZeroBraneStudio调试, will open lua socket automatically.
#else
    public static bool openZbsDebugger = false;         //是否连接ZeroBraneStudio调试, will open lua socket automatically.
#endif
}