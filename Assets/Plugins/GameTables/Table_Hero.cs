...
public class Tab_Hero
{ private const string TAB_FILE_DATA = "Tables/Hero.txt";
 enum _ID
 {
 INVLAID_INDEX=-1,
ID_ID,
...
private int m_InitQuality;
 public int InitQuality { get{ return m_InitQuality;}}
...
_values.m_InitQuality =  Convert.ToInt32(valuesList[(int)_ID.ID_INITQUALITY] as string);
